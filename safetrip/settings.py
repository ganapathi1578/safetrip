...
SECRET_KEY = 'q*+^c8tsnsdpds-#edn0)wz2=wfe10d%s6loc$%yfx^mi-q3s3'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ganapathi1578@gmail.com'
EMAIL_HOST_PASSWORD = 'dnpz cyol smfv xcqy'  # use app password if Gmail
